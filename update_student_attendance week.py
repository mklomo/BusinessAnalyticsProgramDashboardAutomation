...
FOLDER_PATH = os.path.join("C:/Users/INNO/Desktop/AI Academy/Attendance/Week 1/*")

FINAL_DF = "C:/Users/INNO/Desktop/AI Academy/Attendance/Week 1/computed_df.csv"
        ...
        if folder.endswith("Monday"):
            ...
            for file in glob.glob(files_path):
                ...
                try:
                    ...
                    excel_file = pd.read_csv(file, usecols = ['Duration', 'Email', 'Participant ID (UPN)'])
        
    
                except UnicodeDecodeError: 
                    excel_file = pd.read_csv(file, encoding='UTF-16', sep="\t", usecols = ['Duration', 'Email', 'Participant ID (UPN)'])
    ...
    with pyodbc.connect('DRIVER='+driver+';SERVER=tcp:'+server+';PORT=1433;DATABASE='+database+';UID='+username+';PWD='+ password) as conn:
        ...
        with conn.cursor() as cursor:
            ...
            for index, row in attendance_df.iterrows():
                ...
                data_tuple = (attendance_monday, attendance_wednesday, student_email, date)
                
                attendance_list.append(data_tuple)
                
            sql_query = """UPDATE student_attendance
                           
                           SET attendance_monday = ?,
                               attendance_wednesday = ?
                           WHERE student_email = ? AND
                                 date = ?
                        """      
